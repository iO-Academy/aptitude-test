...
document.querySelector('#flag-checkbox').addEventListener('input', updateFlagStatus)
document.querySelector('#flag-button').addEventListener('click', () => {
    console.log('clicked')
    let flagCheckbox = document.querySelector('#flag-checkbox')
    if (flagCheckbox.checked === true) {
